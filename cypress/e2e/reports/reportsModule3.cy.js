...
describe("Timesheet module", () => {
  ...
  it("Scheduling Jobs by Customer >validate the reports using the job number", function () {
    // Dashboard.clickSchedulingTab();
    /* Add Schedule */
    ...
    ReportsPage.gotoJobsByCustomer();
    ReportsPage.selectCustomer("f1439");
