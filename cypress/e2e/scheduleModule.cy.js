...
describe('Schedule Module', () => {
    ...
    it.only('Add default Job - Customer with 1 equipment - Add an Equipment - Add 1 Employee -Add attachments - Add a Task - Assert: customer details, service location - assert info after creation', () => {
